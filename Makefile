...
# Create a virtualenv in .virtualenv or the directory given in the following form: 'make virtualenv VIRTUALENV=.virtualenv2 install'
.PHONY: virtualenv
virtualenv:
...
# following form: 'make release-virtualenv RELEASE_VIRTUALENV=.release-virtualenv2 install'
