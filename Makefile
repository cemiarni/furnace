...
# Create a virtualenv in .venv or the directory given in the following form: 'make venv VIRTUALENV=.venv2 install'
.PHONY: venv
venv:
	python3 -m venv $(VIRTUALENV)
	$(VIRTUALENV)/bin/pip install --upgrade pip

# Create a virtualenv in .release-venv or the directory given in the
# following form: 'make release-venv RELEASE_VIRTUALENV=.release-venv2 install'
.PHONY: release-venv
release-venv:
